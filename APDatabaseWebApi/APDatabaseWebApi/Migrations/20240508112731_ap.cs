...
namespace APDatabaseWebApi.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultTermsID = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((3))"),
                    DefaultAccountNo = table.Column<int>(type: "int", nullable: false, defaultValueSql: "((570))")
                },
                constraints: table =>
                {
