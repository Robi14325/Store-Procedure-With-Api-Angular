...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APDatabaseWebApi.Models.ContactUpdate", b =>
                {
            ...
            modelBuilder.Entity("APDatabaseWebApi.Models.Glaccount", b =>
                {
            ...
            modelBuilder.Entity("APDatabaseWebApi.Models.Invoice", b =>
                {
            ...
            modelBuilder.Entity("APDatabaseWebApi.Models.InvoiceArchive", b =>
                {
                    b.Property<decimal>("CreditTotal")
                        .HasColumnType("money");
            ...
            modelBuilder.Entity("APDatabaseWebApi.Models.InvoiceLineItem", b =>
                {
                    b.Property<int>("InvoiceId")
                        .HasColumnType("int")
                        .HasColumnName("InvoiceID");
            ...
            modelBuilder.Entity("APDatabaseWebApi.Models.Term", b =>
                {
                    b.Property<int>("TermsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TermsId"), 1L, 1);
            ...
            modelBuilder.Entity("APDatabaseWebApi.Models.Vendor", b =>
                {
                    b.Property<int>("VendorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APDatabaseWebApi.Models.Invoice", b =>
                {
                    b.HasOne("APDatabaseWebApi.Models.Term", "Terms")
                        .WithMany("Invoices")
                        .HasForeignKey("TermsId")
                        .IsRequired()
                        .HasConstraintName("FK_Invoices_Terms");

                    b.HasOne("APDatabaseWebApi.Models.Vendor", "Vendor")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("APDatabaseWebApi.Models.InvoiceLineItem", b =>
                {
                    b.HasOne("APDatabaseWebApi.Models.Glaccount", "AccountNoNavigation")
                        .WithMany("InvoiceLineItems")
                        .HasForeignKey("AccountNo")
                        .IsRequired()
                        .HasConstraintName("FK_InvoiceLineItems_GLAccounts");

                    b.HasOne("APDatabaseWebApi.Models.Invoice", "Invoice")
                        .WithMany("InvoiceLineItems")
            ...
            modelBuilder.Entity("APDatabaseWebApi.Models.Vendor", b =>
                {
                    b.HasOne("APDatabaseWebApi.Models.Glaccount", "DefaultAccountNoNavigation")
                        .WithMany("Vendors")
                        .HasForeignKey("DefaultAccountNo")
                        .IsRequired()
                        .HasConstraintName("FK_Vendors_GLAccounts");

                    b.HasOne("APDatabaseWebApi.Models.Term", "DefaultTerms")
                        .WithMany("Vendors")
